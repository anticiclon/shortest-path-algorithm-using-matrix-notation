...
int main()
{
    ...
    dijkstra(ptr_graph, nodo_partida, V, ptr_distancia, ptr_conjunto, ptr_padres);

    std::cout << '\n';
    int distance{ dijkstraDistance(ptr_graph, nodo_partida, nodo_final, V, ptr_distancia, ptr_conjunto, ptr_padres) };
    std::cout << "La distancia minima entre el nodo " << nodo_partida << " y el nodo " << nodo_final << " es " << distance << '\n';


    std::vector<int> camino = dijkstraPath(ptr_graph, nodo_partida, nodo_final, V, ptr_distancia, ptr_conjunto, ptr_padres);
